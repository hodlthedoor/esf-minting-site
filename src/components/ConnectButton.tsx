...
export function ConnectButton() {
  ...
  // Fix hydration mismatch by only rendering the component content after mounting
  useEffect(() => {
    setIsMounted(true);
  }, []);
  ...
  if (!isMounted) {
    return (
      <div className="relative">
        <button className="flex items-center px-4 py-2 space-x-2 text-base text-white rounded-lg transition-colors bg-gradient-to-r from-green-500/20 to-cyan-500/20 border border-green-400/50">
  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center px-4 py-2 space-x-2 text-base font-medium text-white bg-gradient-to-r from-green-500/20 to-cyan-500/20 hover:from-green-500/30 hover:to-cyan-500/30 rounded-lg transition-colors border border-green-400/50 shadow-lg shadow-cyan-500/20"
      >
        <div className="w-7 h-7 rounded-lg bg-cyan-500/20 border border-cyan-400/50 flex-shrink-0" />
